import { c as create_ssr_component, s as spread, f as escape_object, d as escape_attribute_value, b as each, v as validate_component, a as add_attribute } from './ssr-CWJ7--iU.js';
import { j as compute_rest_props, a as subscribe, f as getContext, s as setContext, g as get_store_value } from './lifecycle-CY0VpZrS.js';
import { i as is_void, c as cn, f as flyAndScale } from './utils-BxIOvjB_.js';
import { n as noop, w as withGet, i as isHTMLElement$1, u as useEscapeKeydown, t as toWritableStores, o as omit, a as overridable, b as nanoid, c as wrapArray, e as executeCallbacks, g as generateIds, m as makeElement, s as styleToString, p as portalAttr, d as effect, f as addMeltEventListener, F as FIRST_LAST_KEYS, k as kbd, S as SELECTION_KEYS, h as isElementDisabled, j as safeOnMount, l as addEventListener, q as isBrowser, r as isFunction, v as createElHelpers, x as disabledAttr, y as isElement$1, z as last } from './button-B24JzdgH.js';
import { c as createDispatcher, d as disabledAttrs, a as createBitAttrs } from './events-QmgrkfXC.js';
...
const Menu_item = create_ssr_component(($$result, $$props, $$bindings, slots2) => {
  let builder;
  let attrs;
  ...
  $$unsubscribe_item();
  return `${asChild ? `${slots2.default ? slots2.default({ builder }) : ``}` : `${((tag) => {
    return tag ? `<${href ? "a" : "div"}${spread(
      ...
      {}
    )}${add_attribute("this", el, 0)}>${is_void(tag) ? "" : `${slots2.default ? slots2.default({ builder }) : ``}`}${is_void(tag) ? "" : `</${tag}>`}` : "";
  })(href ? "a" : "div")}`}`;
});
const Menu_group = create_ssr_component(($$result, $$props, $$bindings, slots2) => {
  let builder;
  ...
  $$unsubscribe_group();
  return `${asChild ? `${slots2.default ? slots2.default({ builder }) : ``}` : `<div${spread([escape_object(builder), escape_object($$restProps)], {})}${add_attribute("this", el, 0)}>${slots2.default ? slots2.default({ builder }) : ``}</div>`}`;
});
const Menu_label = create_ssr_component(($$result, $$props, $$bindings, slots2) => {
  let builder;
  let $$restProps = compute_rest_props($$props, ["asChild", "el"]);
...
const Menu_separator = create_ssr_component(($$result, $$props, $$bindings, slots2) => {
  let builder;
  let $$restProps = compute_rest_props($$props, ["asChild", "el"]);
  ...
  return `${asChild ? `${slots2.default ? slots2.default({ builder }) : ``}` : `<div${spread([escape_object($separator), escape_object($$restProps)], {})}${add_attribute("this", el, 0)}></div>`}`;
});
const Menu = create_ssr_component(($$result, $$props, $$bindings, slots2) => {
  ...
  return `${slots2.default ? slots2.default({ ids: $idValues }) : ``}`;
});
const Menu_content = create_ssr_component(($$result, $$props, $$bindings, slots2) => {
  let builder;
  ...
  $$unsubscribe_open();
  $$unsubscribe_menu();
  return `${asChild && $open ? `${slots2.default ? slots2.default({ builder }) : ``}` : `${transition && $open ? `<div${spread([escape_object(builder), escape_object($$restProps)], {})}${add_attribute("this", el, 0)}>${slots2.default ? slots2.default({ builder }) : ``}</div>` : `${inTransition && outTransition && $open ? `<div${spread([escape_object(builder), escape_object($$restProps)], {})}${add_attribute("this", el, 0)}>${slots2.default ? slots2.default({ builder }) : ``}</div>` : `${inTransition && $open ? `<div${spread([escape_object(builder), escape_object($$restProps)], {})}${add_attribute("this", el, 0)}>${slots2.default ? slots2.default({ builder }) : ``}</div>` : `${outTransition && $open ? `<div${spread([escape_object(builder), escape_object($$restProps)], {})}${add_attribute("this", el, 0)}>${slots2.default ? slots2.default({ builder }) : ``}</div>` : `${$open ? `<div${spread([escape_object(builder), escape_object($$restProps)], {})}${add_attribute("this", el, 0)}>${slots2.default ? slots2.default({ builder }) : ``}</div>` : ``}`}`}`}`}`}`;
});
const Menu_trigger = create_ssr_component(($$result, $$props, $$bindings, slots2) => {
  let builder;
  ...
  $$unsubscribe_trigger();
  return `${asChild ? `${slots2.default ? slots2.default({ builder }) : ``}` : `<button${spread([escape_object(builder), { type: "button" }, escape_object($$restProps)], {})}${add_attribute("this", el, 0)}>${slots2.default ? slots2.default({ builder }) : ``}</button>`}`;
});
...
const Icon = create_ssr_component(($$result, $$props, $$bindings, slots2) => {
  ...
  })}${slots2.default ? slots2.default({}) : ``}</svg>`;
});
const Ellipsis = create_ssr_component(($$result, $$props, $$bindings, slots2) => {
  const iconNode = [
...
const Dropdown_menu_item = create_ssr_component(($$result, $$props, $$bindings, slots2) => {
...
const Dropdown_menu_label = create_ssr_component(($$result, $$props, $$bindings, slots2) => {
  let $$restProps = compute_rest_props($$props, ["class", "inset"]);
  let { class: className = void 0 } = $$props;
  let { inset = void 0 } = $$props;
  if ($$props.class === void 0 && $$bindings.class && className !== void 0) $$bindings.class(className);
...
const Dropdown_menu_content = create_ssr_component(($$result, $$props, $$bindings, slots2) => {
...
const Dropdown_menu_separator = create_ssr_component(($$result, $$props, $$bindings, slots2) => {
...
async function unsubscribe_slot(user_id, slot_id) {
...
export { Dropdown_menu_content as D, Ellipsis as E, Group as G, Icon as I, Root as R, Trigger as T, Dropdown_menu_label as a, Dropdown_menu_item as b, createRender as c, Dropdown_menu_separator as d, attendees as e, unsubscribe_slot as f, getPositioningUpdater as g, createTypeaheadSearch as h, derivedVisible as i, usePopper as j, getPortalDestination as k, addHighlight as l, removeScroll as m, participants as p, removeHighlight as r, slots as s, users as u };
//# sourceMappingURL=stores2-D9kX37m3.js.map
