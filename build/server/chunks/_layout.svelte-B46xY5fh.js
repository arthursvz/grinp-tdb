import { g as get_store_value, a as subscribe, h as null_to_empty, j as compute_rest_props, o as onDestroy, n as noop } from './lifecycle-CY0VpZrS.js';
import { c as create_ssr_component, v as validate_component, e as escape, a as add_attribute, b as each, s as spread, d as escape_attribute_value, f as escape_object, g as add_styles, h as merge_ssr_styles, m as missing_component } from './ssr-CWJ7--iU.js';
import { B as Button } from './button-B24JzdgH.js';
import { d as derived, w as writable } from './index2-7tr__D8z.js';
...
const Toast = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_heights();
  $$unsubscribe_toasts();
  return `   <li${add_attribute("aria-live", toast2.important ? "assertive" : "polite", 0)} aria-atomic="true" role="status"${add_attribute("tabindex", 0, 0)}${add_attribute("class", cn($$props.class, toastClass, classes?.toast, toast2?.classes?.toast, classes?.[toastType], toast2?.classes?.[toastType]), 0)} data-sonner-toast=""${add_attribute("data-styled", !(toast2.component || toast2?.unstyled || unstyled), 0)}${add_attribute("data-mounted", mounted, 0)}${add_attribute("data-promise", Boolean(toast2.promise), 0)}${add_attribute("data-removed", removed, 0)}${add_attribute("data-visible", isVisible, 0)}${add_attribute("data-y-position", coords[0], 0)}${add_attribute("data-x-position", coords[1], 0)}${add_attribute("data-index", index, 0)}${add_attribute("data-front", isFront, 0)}${add_attribute("data-swiping", swiping, 0)}${add_attribute("data-type", toastType, 0)}${add_attribute("data-invert", invert, 0)}${add_attribute("data-swipe-out", swipeOut, 0)}${add_attribute("data-expanded", Boolean(expanded || expandByDefault && mounted), 0)}${add_styles(merge_ssr_styles(escape(`${$$props.style} ${toast2.style}`, true), {
    "--index": index,
    "--toasts-before": index,
...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_flash();
  return `<div class="page flex h-full md:h-screen flex-col relative"> <div class="background absolute inset-0 svelte-1lug1l5"></div>   <div class="content relative z-10 flex flex-col h-full svelte-1lug1l5"> ${validate_component(Button, "Button").$$render(
    $$result,
    {
      class: "md:hidden hamburger-button h-16 flex justify-start",
      variant: "background"
    },
    {},
    {
      default: () => {
        return `<div class="${escape(null_to_empty(`hamburger ${""}`), true) + " svelte-1lug1l5"}"><span class="line svelte-1lug1l5"></span> <span class="line svelte-1lug1l5"></span> <span class="line svelte-1lug1l5"></span></div>`;
      }
    }
  )}  <header class="${escape(
    null_to_empty(`sticky top-0 flex max-md:flex-col md:h-16 items-center gap-8 border-b bg-background p-4 w-full z-50 justify-between max-md:transition-transform max-md:duration-500 max-md:ease-in-out transform ${"max-md:-translate-y-full"}`),
    true
  ) + " svelte-1lug1l5"}"> <div class="flex flex-col items-center gap-4 md:flex-row">${validate_component(Button, "Button").$$render(
    $$result,
    {
      href: "/",
  ...
  )} ${user ? `${validate_component(Button, "Button").$$render($$result, { href: "/calendar", variant: "tertiary" }, {}, {
    default: () => {
      return `Créneaux`;
    }
  })}` : ``}</div>  <div class="flex flex-col items-center gap-4 md:flex-row">${!user ? `${validate_component(Button, "Button").$$render(
    $$result,
    {
      href: "/login",
      class: "flex mx-4 md:px-4",
  ...
  )}` : ` ${root ? `${validate_component(Button, "Button").$$render(
    $$result,
    {
      href: "/admin",
      class: "flex mx-4 md:px-4",
  ...
  )}`}</div></header> <div class="h-screen">${slots.default ? slots.default({}) : ``}</div></div> ${validate_component(Sonner_1, "Toaster").$$render($$result, {}, {}, {})} </div>`;
});

export { Layout as default };
//# sourceMappingURL=_layout.svelte-B46xY5fh.js.map
