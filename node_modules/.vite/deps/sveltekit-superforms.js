...
function create_if_block_5(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      add_location(style, file, 435, 1, 11124);
    },
...
function create_if_block(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(div0, file, 667, 3, 16563);
      attr_dev(button, "type", "button");
      attr_dev(button, "class", "super-debug--copy");
      add_location(button, file, 669, 4, 16656);
      attr_dev(div1, "class", "super-debug--right-status");
      add_location(div1, file, 668, 3, 16612);
      ...
      add_location(div2, file, 662, 2, 16424);
      attr_dev(code, "class", "super-debug--code");
      add_location(code, file, 721, 19, 18313);
      ...
      add_location(pre, file, 717, 2, 18179);
      ...
      add_location(div3, file, 656, 1, 16312);
    },
    m: function mount(target, anchor) {
...
function create_else_block_1(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(path0, file, 693, 9, 17556);
...
function create_if_block_4(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(path0, file, 678, 9, 16996);
      attr_dev(path1, "d", "M4.012 16.737A2.005 2.005 0 0 1 3 15V5c0-1.1.9-2 2-2h10c.75 0 1.158.385 1.5 1");
      add_location(path1, file, 680, 10, 17161);
      attr_dev(g, "fill", "none");
      attr_dev(g, "stroke", "currentColor");
      attr_dev(g, "stroke-linecap", "round");
      attr_dev(g, "stroke-linejoin", "round");
      attr_dev(g, "stroke-width", "2");
      add_location(g, file, 672, 8, 16846);
      attr_dev(svg, "xmlns", "http://www.w3.org/2000/svg");
      attr_dev(svg, "width", "1em");
      attr_dev(svg, "height", "1em");
      attr_dev(svg, "viewBox", "0 0 24 24");
      add_location(svg, file, 671, 6, 16753);
    },
    m: function mount(target, anchor) {
      insert_hydration_dev(target, svg, anchor);
      append_hydration_dev(svg, g);
...
function create_if_block_3(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(div, file, 706, 5, 17844);
    },
    m: function mount(target, anchor) {
...
function create_if_block_2(ctx) {
  ...
  dispatch_dev("SvelteRegisterBlock", {
    ...
    type: "if",
    source: "(724:6) {#if assertPromise($debugData, raw, promise)}",
    ctx
  });
  return block;
}
function create_catch_block(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(span, file, 726, 23, 18614);
      html_tag.a = html_anchor;
    },
    m: function mount(target, anchor) {
...
function create_pending_block(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(div, file, 723, 70, 18426);
    },
    m: function mount(target, anchor) {
      insert_hydration_dev(target, div, anchor);
    },
  ...
  dispatch_dev("SvelteRegisterBlock", {
    ...
    type: "pending",
    source: '(724:70) <div         class=\\"super-debug--promise-loading\\">Loading data...</div>{:then result}',
    ctx
  });
  return block;
}
...
function create_if_block_1(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(path, file, 744, 6, 19118);
      attr_dev(svg, "xmlns", "http://www.w3.org/2000/svg");
      ...
      add_location(svg, file, 738, 4, 18965);
      attr_dev(button, "type", "button");
      attr_dev(button, "class", "super-debug--collapse");
      add_location(button, file, 733, 3, 18836);
    },
    m: function mount(target, anchor) {
